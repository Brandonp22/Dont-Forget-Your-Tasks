        ...
        <ion-content class="overflow-auto">
            <div class="flex flex-col justify-center items-center mt-2">
                ...
                <div class="text-center">
                    ...
                    <ion-card-subtitle>{{state.tasksSport.length}} Tareas</ion-card-subtitle>
                </div>
            </div>
...
export default defineComponent({
    ...
    setup(){
        ...
        const state = reactive({
            tasksSport: computed(() => {
                return store.getters.tasksByCategory('Deportes');
            }),
            today: computed(() => {
        ...
        return{
            isOpenNewTask,store,state,getTasksSport,doneTask,notDoneTask,deleteTask,
