    ...
    <ion-page>
        ...
        <ion-content class="overflow-auto">
            <div class="flex flex-col justify-center items-center mt-2">
                ...
                <div class="text-center">
                    <ion-card-title class="text-2xl">Compras</ion-card-title>
                        <ion-card-subtitle>{{state.tasksShopping.length}} Tareas</ion-card-subtitle>
            ...
            <div>
                <ion-list>
                    <ion-list-header>
                        <ion-label>Tarde <span class="text-gray-600 text-base">{{state.late.length}}</span></ion-label>
                    </ion-list-header>
                ...
                <ion-list>
                    <ion-list-header>
                        <ion-label>Hoy <span class="text-gray-600 text-base">{{state.today.length}}</span></ion-label>
                    </ion-list-header>
                ...
                <ion-list>
                    <ion-list-header>
                        <ion-label>Más Tarde <span class="text-gray-600 text-base">{{state.later.length}}</span></ion-label>
                    </ion-list-header>
                ...
                <ion-list>
                    <ion-list-header>
                        <ion-label>Terminado <span class="text-gray-600 text-base">{{state.done.length}}</span></ion-label>
                    </ion-list-header>
    ...
    setup(){
        ...
        const state = reactive({
            tasksShopping: computed(() => {
                return store.getters.tasksByCategory('Compras');
            }),
            today: computed(() => {
        ...
        return{
            isOpenNewTask,store,state,getTasksShopping,doneTask,notDoneTask,deleteTask,
