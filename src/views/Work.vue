    ...
    <ion-content class="overflow-auto">
        <div class="flex flex-col justify-center items-center mt-2">
            ...
            <div class="text-center">
                ...
                <ion-card-subtitle>{{state.tasksWork.length}} Tareas</ion-card-subtitle>
            </div>
        </div>
...
export default defineComponent({
    ...
    setup(){
        ...
        const state = reactive({
            tasksWork: computed(() => {
                return store.getters.tasksByCategory('Trabajo');
            }),
            today: computed(() => {
        ...
        return{
            isOpenNewTask,store,state,getTasksWork,doneTask,notDoneTask,deleteTask,
