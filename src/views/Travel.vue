    ...
    <ion-content class="overflow-auto">
        <div class="flex flex-col justify-center items-center mt-2">
            ...
            <div class="text-center">
                ...
                <ion-card-subtitle>{{state.tasksTravel.length}} Tareas</ion-card-subtitle>
            </div>
        </div>
   ...
   setup(){
        ...
        const state = reactive({
            tasksTravel: computed(() => {
                return store.getters.tasksByCategory('Viajes');
            }),
            today: computed(() => {
        ...
        return{
            isOpenNewTask,store,state,getTasksTravel,doneTask,notDoneTask,deleteTask,
