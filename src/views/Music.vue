    ...
    <ion-page>
        ...
        <ion-content class="overflow-auto">
            <div class="flex flex-col justify-center items-center mt-2">
                ...
                <div class="text-center">
                    <ion-card-title class="text-2xl">Música</ion-card-title>
                    <ion-card-subtitle>{{state.tasksMusic.length}} Tareas</ion-card-subtitle>
                </div>
            </div>
...
export default defineComponent({
    ...
    setup(){
        ...
        const state = reactive({
            tasksMusic: computed(() => {
                return store.getters.tasksByCategory('Musica');
            }),
            today: computed(() => {
